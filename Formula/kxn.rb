class Kxn < Formula
  ...
  # Note: repo is private. Use install.sh for now:
  #   gh release download v0.1.0 --repo kexa-io/kxn --pattern "kxn-*.tar.gz"
  # Or: curl -sL https://raw.githubusercontent.com/kexa-io/kxn/main/install.sh | bash
